...
do {
  ...
  Write-Host "Stiskni 0 => Ukonci program"
	...
	switch ($userInput) {
    '1' {
      # Získání cesty k databázi na začátku
      Write-Host "Probíhá komplet spuštění. Vyberte databázi pro ukládání informací:"
      $databasePath = GetFileName("D:\Documents\DiplProg")
        ...
        { & ".\compareFirewallRulesDB.ps1" -databasePath $databasePath },
        { & ".\createLocalPoliciesDB.ps1" -databasePath $databasePath },
        { & ".\compareLocalPoliciesDB.ps1" -databasePath $databasePath }
      )
    ...
    '7' {
      ...
      & ".\compareFirewallRulesDB.ps1" -mode "manual"
    }
    '8' {
    ...
    '9' {
      ...
      & ".\compareLocalPoliciesDB.ps1" -mode "manual"
    }
    '0' {
